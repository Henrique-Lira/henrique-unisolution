...
{
    public partial class Added_Tanks : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Deposito = table.Column<string>(maxLength: 512, nullable: false),
                    ...
                    TipoDeProduto = table.Column<string>(maxLength: 256, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Tanks", x => x.Deposito);
                });
        }
