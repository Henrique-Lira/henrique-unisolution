...
namespace Henrique.Unisolution.EntityFrameworkCore.Seed.Host
{
    public class HostRoleAndUserCreator
    {
        ...
        public HostRoleAndUserCreator(UnisolutionDbContext context)
        {
            _context = context;
        }
        ...
        private void CreateHostRoleAndUsers()
        {
            ...
            var permissions = PermissionFinder
                .GetAllPermissions(new UnisolutionAuthorizationProvider())
            ...
            if (adminUserForHost == null)
            {
                var user = new User
                {
                    ...
                    Name = "Henrique",
                    Surname = "Lira",
                    EmailAddress = "henrique.lira@thinkamconnect.com",
