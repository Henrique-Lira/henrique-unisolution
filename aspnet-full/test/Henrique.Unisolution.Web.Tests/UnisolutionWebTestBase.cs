...
{
    public abstract class UnisolutionWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static UnisolutionWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(UnisolutionWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<UnisolutionDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<UnisolutionDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<UnisolutionDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<UnisolutionDbContext, Task<T>> func)
        {
            T result;
